...
public class DescribeRemoteManagementsResult implements Serializable, Cloneable {
    ...
    public  List<RemoteManagement> getRemoteManagementSet() {
        return RemoteManagementSet;
    }
    ...
    public String toString() {
        return "DescribeRemoteManagementsResult(RequestId=" + this.getRequestId() + ",RemoteManagementSet=" + this.getRemoteManagementSet() + ",TotalCount=" + this.getTotalCount() + ",NextToken=" + this.getNextToken() + ")";
    }
}
